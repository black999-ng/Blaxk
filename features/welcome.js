...
async function sendWelcomeMessage(sock, groupJid, userJid) {
  ...
  // await sock.sendMessage(groupJid, { image: { url: ppUrl }, caption, mentions: [userId], contextInfo: { forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363423276650635@newsletter', newsletterName: '""""', serverMessageId: -1 } } });
}
